...
shinyUI(fluidPage(
        ...
        sidebarLayout(
                sidebarPanel(
                        ...
                        br(),
                        h4("4. View the summary() or structure() of the acc data with the Summary or Structure Tabs"),
                        br(),
                        br(),
